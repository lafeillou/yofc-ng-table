            ...
            function(module, exports, __webpack_require__) {
                ...
                var NgTableParams = (function() {
                    function NgTableParams(baseParameters, baseSettings) {
                         ...
                         */
                        this.appointPage = "";
                        // the flag show pager or not
                        this.isShowPager = baseParameters.isShowPager === false ? false : true; 
                    ...
                    NgTableParams.prototype.goAppointPage = function(page) {
                        ...
                        if( parseFloat(page) > 0) {
                            page = parseFloat(maxPage) >= parseFloat(page) ? page : maxPage;
                            this.appointPage = page;
                            this.parameters({
                                'page': page
                            });
                        }
